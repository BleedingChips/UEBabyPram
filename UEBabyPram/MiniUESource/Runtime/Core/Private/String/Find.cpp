...
{
	return Private::FindFirstOfAnyChar(View, MakeArrayView(Search), SearchCase, OutMatchIndex);
}
...
{
	return Private::FindLastOfAnyChar(View, MakeArrayView(Search), SearchCase, OutMatchIndex);
}
