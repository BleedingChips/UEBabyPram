...
FTextFilterString::FTextFilterString() = default;

FTextFilterString::FTextFilterString(const FTextFilterString& Other) = default;

FTextFilterString::FTextFilterString(FTextFilterString&& Other) = default;
...
FTextFilterString& FTextFilterString::operator=(const FTextFilterString& Other) = default;

FTextFilterString& FTextFilterString::operator=(FTextFilterString&& Other) = default;
