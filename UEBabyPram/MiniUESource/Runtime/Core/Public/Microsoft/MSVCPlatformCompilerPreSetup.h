...
// HEADER_UNIT_SKIP - Cause cirular dependencies for header units
	...
	#define EMIT_CUSTOM_ERROR_AT_LINE(Line, Error) \
		...
		#define PRAGMA_PUSH_ATTRIBUTE_MINSIZE_FUNCTIONS // no-op for now
	#endif // PRAGMA_PUSH_ATTRIBUTE_MINSIZE_FUNCTIONS

	#ifndef PRAGMA_POP_ATTRIBUTE_MINSIZE_FUNCTIONS
		#define PRAGMA_POP_ATTRIBUTE_MINSIZE_FUNCTIONS // no-op for now
	#endif // PRAGMA_POP_ATTRIBUTE_MINSIZE_FUNCTIONS

	#ifndef PGO_LINK_DISABLE_WARNINGS
		#define PGO_LINK_DISABLE_WARNINGS PRAGMA_DISABLE_BUFFER_OVERRUN_WARNING
	#endif

	#ifndef PGO_LINK_ENABLE_WARNINGS
		#define PGO_LINK_ENABLE_WARNINGS PRAGMA_ENABLE_BUFFER_OVERRUN_WARNING
	#endif
