...
public:
	...
	*/
	...
	static FMultiSelectActorBegin& OnMultiSelectActorBegin() { return MultiSelectActorBegin; }

	DECLARE_DELEGATE(FMultiSelectActorEnd);
	static FMultiSelectActorEnd& OnMultiSelectActorEnd() { return MultiSelectActorEnd; }
...
private:
	...
	/** Delegates for multi-select of message token actors */
	CORE_API static FMultiSelectActorBegin MultiSelectActorBegin;
	CORE_API static FMultiSelectActorEnd MultiSelectActorEnd;
};
