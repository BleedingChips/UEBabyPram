 ...
 */
CORE_API int32 FindFirstOfAnyChar(FUtf8StringView View, std::initializer_list<UTF8CHAR> Search, ESearchCase::Type SearchCase = ESearchCase::CaseSensitive, int32* OutMatchIndex = nullptr);
 ...
 * @return The position at which any search character was found, or INDEX_NONE if not found.
 */
CORE_API int32 FindLastOfAnyChar(FUtf8StringView View, std::initializer_list<UTF8CHAR> Search, ESearchCase::Type SearchCase = ESearchCase::CaseSensitive, int32* OutMatchIndex = nullptr);
