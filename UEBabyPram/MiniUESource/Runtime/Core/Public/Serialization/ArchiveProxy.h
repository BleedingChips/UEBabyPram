...
public:
	...
	inline void SetSerializedProperty(FProperty* InProperty) override
	{
	...
	virtual inline void PushSerializedProperty(class FProperty* InProperty, const bool bIsEditorOnlyProperty) override
	{
	...
	virtual inline void PopSerializedProperty(class FProperty* InProperty, const bool bIsEditorOnlyProperty) override
	{
	...
	virtual UE_FORCEINLINE_HINT bool IsEditorOnlyPropertyOnTheStack() const override
	{
