...
public:
	...
	*/
	...
	UE_FORCEINLINE_HINT int64 GetFrozenOffsetFromThis() const { return Data.GetFrozenOffsetFromThis(); }
...
public:
	...
	public:
		ForElementType() {}
		UE_FORCEINLINE_HINT ElementType* GetAllocation() const { return (ElementType*)ForAnyElementType::GetAllocation(); }
	};
};
...
public:
	...
	UE_FORCEINLINE_HINT FMemoryImageString(const FString& Other) : Data(Other.GetCharArray()) {}
	...
	>
		inline FMemoryImageString(const CharType* Src)
	{
		if (Src && *Src)
		{
	...
	UE_FORCEINLINE_HINT bool IsEmpty() const { return Data.Num() <= 1; }
	UE_FORCEINLINE_HINT SIZE_T GetAllocatedSize() const { return Data.GetAllocatedSize(); }
