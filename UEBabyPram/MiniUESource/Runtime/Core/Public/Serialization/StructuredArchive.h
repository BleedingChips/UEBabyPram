...
namespace UE::StructuredArchive::Private
{
	UE_FORCEINLINE_HINT FArchive& GetUnderlyingArchiveImpl(FStructuredArchive& StructuredArchive)
	{
		return StructuredArchive.GetUnderlyingArchive();
	}

	UE_FORCEINLINE_HINT FArchiveState& GetUnderlyingArchiveStateImpl(FStructuredArchive& StructuredArchive)
	{
		return StructuredArchive.GetUnderlyingArchive().GetArchiveState();
	}

#if WITH_TEXT_ARCHIVE_SUPPORT
	UE_FORCEINLINE_HINT FElementId GetCurrentSlotElementIdImpl(FStructuredArchive& StructuredArchive)
	{
		return StructuredArchive.CurrentSlotElementId;
	}
#endif

	UE_FORCEINLINE_HINT FArchiveFormatterType& GetFormatterImpl(FStructuredArchive& StructuredArchive)
	{
