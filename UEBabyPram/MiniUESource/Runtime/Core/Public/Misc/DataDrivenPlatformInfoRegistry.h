...
struct FDataDrivenPlatformInfoRegistry
{
	...
	*/
	...
	/**
	 * Retrieve the PreviewPlatform MenuItems for ShaderPlatformName
	*/
	static CORE_API const TArray<struct FPreviewPlatformMenuItem>* GetMenuItemForShaderPlatformName(FName ShaderPlatformName);
