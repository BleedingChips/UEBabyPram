...
struct TCString
{
	...
	static inline CharType* Strcpy(CharType* Dest, SIZE_T DestCount, const CharType* Src);
	 ...
	 */
	static inline CharType* Strncpy( CharType* Dest, const CharType* Src, SIZE_T MaxLen );
	...
	static UE_FORCEINLINE_HINT CharType* Strcpy( CharType (&Dest)[DestCount], const CharType* Src ) 
	{
	...
	static inline CharType* Strcat(CharType* Dest, SIZE_T DestSize, const CharType* Src);
	 ...
	 */
	template<SIZE_T DestCount>
	static UE_FORCEINLINE_HINT CharType* Strcat( CharType (&Dest)[DestCount], const CharType* Src ) 
	{ 
	 ...
	 * strlen wrapper
	 */
	static inline int32 Strlen( const CharType* String );
	...
	static UE_FORCEINLINE_HINT CharType* Strstr( CharType* String, const CharType* Find );

	/**
	 * strchr wrapper
	 */
	static UE_FORCEINLINE_HINT const CharType* Strchr( const CharType* String, CharType c );
	static UE_FORCEINLINE_HINT CharType* Strchr( CharType* String, CharType c );

	/**
	 * strrchr wrapper
	 */
	static UE_FORCEINLINE_HINT const CharType* Strrchr( const CharType* String, CharType c );
	static UE_FORCEINLINE_HINT CharType* Strrchr( CharType* String, CharType c );

	/**
	 * strrstr wrapper
	 */
	static UE_FORCEINLINE_HINT const CharType* Strrstr( const CharType* String, const CharType* Find );
	static inline CharType* Strrstr( CharType* String, const CharType* Find );

	/**
	 * strspn wrapper
	 */
	static inline int32 Strspn( const CharType* String, const CharType* Mask );

	/**
	 * strcspn wrapper
	 */
	static inline int32 Strcspn( const CharType* String, const CharType* Mask );
...
template <typename T> UE_FORCEINLINE_HINT
...
template <typename T>
UE_NODEBUG inline int32 TCString<T>::Strlen( const CharType* String ) 
{
