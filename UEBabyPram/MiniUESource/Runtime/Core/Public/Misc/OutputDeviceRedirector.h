...
public:
	 ...
	 */
	UE_DEPRECATED(5.7, "The backlog is now automatically serialized within AddOutputDevice.")
...
/** Tracks pending operations on output devices. */
class FOutputDeviceFence
{
public:
...
private:
	FOutputDeviceFence() = default;

	UE::Private::FOutputDeviceRedirectorState* State = nullptr;
	uint64 Index = 0;

	friend FOutputDeviceRedirector;
};
