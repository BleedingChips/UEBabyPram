...
public:
	...
	inline FTimeGuard(FTimerNameDelegate InNameDelegate, const float InTargetMS = 0.0)
	...
	inline FTimeGuard(TCHAR const* InName, FName InObjectName = NAME_None, const float InTargetMS = 0.0)
		: Name(nullptr), ObjectName(NAME_None)
	{
