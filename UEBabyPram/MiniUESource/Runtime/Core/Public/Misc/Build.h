...
/*--------------------------------------------------------------------------------
	...
	ENABLE_STATNAMEDEVENTS							If true, then enable support for named events from the stat macros without the stat system overhead. This will attempt to disable regular stats system and use named events instead.
...
--------------------------------------------------------------------------------*/
	...
	#endif
	#ifndef ENABLE_STATNAMEDEVENTS
		#define ENABLE_STATNAMEDEVENTS							(!FORCE_USE_STATS && !USE_STATS_WITHOUT_ENGINE)
	#endif
	#ifndef ENABLE_STATNAMEDEVENTS_UOBJECT
		#define ENABLE_STATNAMEDEVENTS_UOBJECT 					(ENABLE_STATNAMEDEVENTS)
	#endif
	#ifndef STATS
...
#ifndef ALLOW_OTHER_PLATFORM_CONFIG
