...
struct FMapErrors
{
	...
	/** {Brush Actor} : Brush has NULL polygons property - please delete!: This warning indicates that you have a brush in the level with a "None" polygons reference.  The brush should be deleted as it isn't doing anything useful. */
	static CORE_API FLazyName BrushNullPolygons;
