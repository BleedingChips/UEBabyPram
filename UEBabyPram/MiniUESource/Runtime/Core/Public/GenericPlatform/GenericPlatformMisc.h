...
struct FGenericPlatformMisc
{
	...
	*/
	 ...
	 *
	 * Note that on modern file systems the concept of "free space" is a bit more loosely defined than one might historically expect due 
	 * to features like on-demand freeing of caches and automatic content deduplication. As a result, this function can be
	 * very slow (10s of ms), and the free space value should not be used for exact measurements.
	*/
