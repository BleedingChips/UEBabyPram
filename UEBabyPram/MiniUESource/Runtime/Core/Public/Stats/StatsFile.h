...
protected:
	...
	inline void WriteFName( FArchive& Ar, FStatNameAndInfo NameAndInfo )
	{
	...
	inline void WriteMessage( FArchive& Ar, FStatMessage const& Item )
	{
...
public:
	...
	inline FStatNameAndInfo ReadFName( FArchive& Ar, bool bHasFNameMap )
	{
	...
	/** Read a stat message. **/
	inline FStatMessage ReadMessage( FArchive& Ar, bool bHasFNameMap = false )
	{
