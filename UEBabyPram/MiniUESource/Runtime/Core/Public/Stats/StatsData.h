...
{
	UE_FORCEINLINE_HINT bool operator()( const FStatMessage& A, const FStatMessage& B ) const
	{
...
{
	inline bool operator()( const FStatMessage& A, const FStatMessage& B ) const
	{
...
{
	UE_FORCEINLINE_HINT bool operator()( const FRawStatStackNode& A, const FRawStatStackNode& B ) const
	{
...
{
	inline bool operator()( const FRawStatStackNode& A, const FRawStatStackNode& B ) const
	{
