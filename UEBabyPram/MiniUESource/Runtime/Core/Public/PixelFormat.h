...
inline bool IsASTCBlockCompressedTextureFormat(EPixelFormat PixelFormat)
{
	PRAGMA_DISABLE_SWITCH_UNHANDLED_ENUM_CASE_WARNINGS;
	switch (PixelFormat)
	{
...
inline bool IsHDR(EPixelFormat PixelFormat)
{
...
inline bool IsInteger(EPixelFormat PixelFormat)
{
	PRAGMA_DISABLE_SWITCH_UNHANDLED_ENUM_CASE_WARNINGS;
	switch (PixelFormat)
	{
...
inline bool IsDXTCBlockCompressedTextureFormat(EPixelFormat PixelFormat)
{
	PRAGMA_DISABLE_SWITCH_UNHANDLED_ENUM_CASE_WARNINGS;
	switch (PixelFormat)
	{
