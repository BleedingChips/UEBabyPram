...
public:
	...
	UE_DEPRECATED(5.7, "HeartBeat(bool bReadConfig) is deprecated, please use HeartBeat() instead.")
	CORE_API void HeartBeat(bool bReadConfig);
...
private:
	...
	bool bSuspended;
public:
	inline FSlowHeartBeatScope(bool bAllThreads = false)
...
public:
	inline FFunctionHeartBeatScope()
