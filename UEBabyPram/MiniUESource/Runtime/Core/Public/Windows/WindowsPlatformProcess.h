...
public:
	...
	UE_FORCEINLINE_HINT explicit FProcHandle( HandleType Other )
		: TProcHandle( Other )
	{}
};
...
private:
	...
	static FProcHandle CreateProcInternal(const TCHAR* URL, const TCHAR* Parms, bool bLaunchDetached, bool bLaunchHidden, bool bLaunchReallyHidden, uint32* OutProcessID, int32 PriorityModifier, const TCHAR* OptionalWorkingDirectory, void* PipeWriteChild, void* PipeReadChild, void* PipeStdErrChild, bool bInheritHandles);
	 ...
	 */
	static void* LoadLibraryWithSearchPaths(const FString& FileName, TConstArrayView<FString> SearchPaths);
	 ...
	 */
	static bool ResolveImport(const FString& Name, TConstArrayView<FString> SearchPaths, FString& OutFileName);
	 ...
	 */
	static void ResolveMissingImportsRecursive(const FString& FileName, TConstArrayView<FString> SearchPaths, TArray<FString>& ImportFileNames, TSet<FString>& VisitedImportNames);
};
