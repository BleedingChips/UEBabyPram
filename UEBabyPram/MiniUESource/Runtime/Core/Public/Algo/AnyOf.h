...
namespace Algo
{
	...
	[[nodiscard]] UE_REWRITE bool AnyOf(const RangeType& Range)
	{
	...
	[[nodiscard]] UE_REWRITE bool AnyOf(const RangeType& Range, ProjectionType Projection)
	{
	 ...
	 */
	template <typename RangeType, typename ProjectionType>
	[[nodiscard]] UE_REWRITE bool AnyOf(const RangeType& Range, ProjectionType Projection, ENoRef NoRef)
	{
