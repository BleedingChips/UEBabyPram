...
namespace Algo
{
	...
	[[nodiscard]] UE_REWRITE auto FindLast(RangeType&& Range, const ValueType& Value)
	...
	[[nodiscard]] UE_REWRITE auto FindLastBy(RangeType&& Range, const ValueType& Value, ProjectionType Proj)
	...
	[[nodiscard]] UE_REWRITE auto FindLastByPredicate(RangeType&& Range, PredicateType Pred)
