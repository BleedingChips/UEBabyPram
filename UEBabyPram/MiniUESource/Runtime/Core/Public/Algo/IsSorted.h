...
namespace Algo
{
	...
	[[nodiscard]] UE_REWRITE bool IsSorted(const RangeType& Range)
	{
	...
	[[nodiscard]] UE_REWRITE bool IsSorted(const RangeType& Range, PredType Pred)
	{
	...
	[[nodiscard]] UE_REWRITE bool IsSortedBy(const RangeType& Range, ProjectionType Projection)
	{
	...
	[[nodiscard]] UE_REWRITE bool IsSortedBy(const RangeType& Range, ProjectionType Projection, PredType Pred)
	{
