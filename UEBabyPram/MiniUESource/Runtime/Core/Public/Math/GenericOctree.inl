...
inline bool FOctreeChildNodeSubset::Contains(FOctreeChildNodeRef ChildRef) const
{
...
inline FOctreeChildNodeSubset FOctreeNodeContext::GetIntersectingChildren(const FBoxCenterAndExtent& QueryBounds) const
{
...
inline FOctreeChildNodeRef FOctreeNodeContext::GetContainingChild(const FBoxCenterAndExtent& QueryBounds) const
{
