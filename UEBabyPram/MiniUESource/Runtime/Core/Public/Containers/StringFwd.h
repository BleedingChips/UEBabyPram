...
template <typename CharType> class TExternalStringBuilder;
...
template <typename CharType> struct TIsContiguousContainer<TExternalStringBuilder<CharType>> { static constexpr bool Value = true; };
...
template <UE::CCharType T>
class TStringView;

template <UE::CCharType CharType> struct TIsContiguousContainer<TStringView<CharType>> { static constexpr bool Value = true; };
