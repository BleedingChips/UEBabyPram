...
public:
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT bool IsLinked()
	{
		return PrevLink != nullptr;
	}

	[[nodiscard]] UE_FORCEINLINE_HINT ContainerType** GetPrevLink() const
	{
		return PrevLink;
	}

	[[nodiscard]] UE_FORCEINLINE_HINT ContainerType* GetNextLink() const
	{
		return NextLink;
	}

	[[nodiscard]] UE_FORCEINLINE_HINT ContainerType* Next()
	{
		return NextLink;
	}
...
private:
	...
	[[nodiscard]] UE_FORCEINLINE_HINT friend TConstIterator begin(const ContainerType& List) { return TConstIterator(const_cast<ContainerType*>(&List)); }
...
public:
	...
	// Accessors.
	[[nodiscard]] UE_FORCEINLINE_HINT ElementType* operator->()
	{
		return &Element;
	}
...
public:
	...
	[[nodiscard]] TDoubleLinkedList(TDoubleLinkedList&& Other)
		: TDoubleLinkedList()
	{
