...
public:
	...
	* @param  bValue      The value (true/false) to search for.
	* @param  StartIndex  The index to start the search from.
	* @param  EndIndexExclusive	  The index to end the search at.
	*
	* @pre StartIndex is expected to be in the inclusive range [0, Num()].
	* @pre EndIndexExclusive is expected to be in the inclusive range [0, Num()].
	*
	* @return The index of the first occurrence of the specified value (true/false) from StartIndex to EndIndexExclusive, or INDEX_NONE if not found.
	*/
	template <typename IndexType>
