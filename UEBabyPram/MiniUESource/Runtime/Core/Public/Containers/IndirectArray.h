...
public:
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT T** GetData()
	{
	 ...
	 * @returns Pointer to first array entry or nullptr if this->ArrayMax == 0.
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT const T** GetData() const
	{
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT T& operator[](int32 Index)
	{
	 ...
	 * @returns Reference to element in array at given position.
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT const T& operator[](int32 Index) const
	{
		return *(T*)Array[Index];
	}
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT ElementType& Last(int32 IndexFromTheEnd = 0)
	{
	 ...
	 * @returns Reference to n-th last element from the array.
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT const ElementType& Last(int32 IndexFromTheEnd = 0) const
	{
		return *(T*)Array.Last(IndexFromTheEnd);
	}
...
public:
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT TDereferencingIterator<      ElementType, typename InternalArrayType::RangedForIteratorType     > begin()       { return TDereferencingIterator<      ElementType, typename InternalArrayType::RangedForIteratorType     >(Array.begin()); }
	[[nodiscard]] UE_FORCEINLINE_HINT TDereferencingIterator<const ElementType, typename InternalArrayType::RangedForConstIteratorType> begin() const { return TDereferencingIterator<const ElementType, typename InternalArrayType::RangedForConstIteratorType>(Array.begin()); }
	[[nodiscard]] UE_FORCEINLINE_HINT TDereferencingIterator<      ElementType, typename InternalArrayType::RangedForIteratorType     > end  ()       { return TDereferencingIterator<      ElementType, typename InternalArrayType::RangedForIteratorType     >(Array.end()); }
	[[nodiscard]] UE_FORCEINLINE_HINT TDereferencingIterator<const ElementType, typename InternalArrayType::RangedForConstIteratorType> end  () const { return TDereferencingIterator<const ElementType, typename InternalArrayType::RangedForConstIteratorType>(Array.end()); }
