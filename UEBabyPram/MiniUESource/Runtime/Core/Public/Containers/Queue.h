 ...
 * Multiple-producers single-consumer (MPSC), Single-producer single-consumer (SPSC), and Single-threaded.
 *
 * The queue is thread-safe in both MPSC and SPSC modes. The Dequeue() method ensures thread-safety by
...
public:
	...
	[[nodiscard]] UE_FORCEINLINE_HINT const FElementType* Peek() const
	{
