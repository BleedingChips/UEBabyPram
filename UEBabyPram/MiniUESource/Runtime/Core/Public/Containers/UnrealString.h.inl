...
public:
	...
	[[nodiscard]] explicit consteval UE_STRING_CLASS(EConstEval) 
		: Data(ConstEval)
	{
	}
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS(const UE_STRING_CLASS& Other, int32 ExtraSlack)
	 ...
	 * @param ExtraSlack number of extra characters to add to the end of the other string in this string
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS(UE_STRING_CLASS&& Other, int32 ExtraSlack)
	...
	>
	[[nodiscard]] UE_FORCEINLINE_HINT explicit UE_STRING_CLASS(CharRangeType&& Str)
	{
...
public:
	...
	[[nodiscard]] inline UE_STRING_CLASS(const CFStringRef In)
	{
	...
	[[nodiscard]] bool UEOpEquals(FIntrusiveUnsetOptionalState Tag) const
	{
		return Data == Tag;
	}
	//////////////////////////////////////////////////////
	...
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS(const NSString* In) : UE_STRING_CLASS((__bridge CFStringRef)In)
	{
	}
#endif
	...
	>
	inline UE_STRING_CLASS& operator=(CharRangeType&& Range)
	{
...
public:
	 ...
	 */
	[[nodiscard]] inline ElementType& operator[](int32 Index) UE_LIFETIMEBOUND
	{
	 ...
	 */
	[[nodiscard]] inline const ElementType& operator[](int32 Index) const UE_LIFETIMEBOUND
	{
		checkf(IsValidIndex(Index), TEXT("String index out of bounds: Index %i from a string with a length of %i"), Index, Len());
		return Data.GetData()[Index];
	}
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForIteratorType             begin ()       { auto Result = Data.begin();                                return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForConstIteratorType        begin () const { auto Result = Data.begin();                                return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForIteratorType             end   ()       { auto Result = Data.end();    if (Data.Num()) { --Result; } return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForConstIteratorType        end   () const { auto Result = Data.end();    if (Data.Num()) { --Result; } return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForReverseIteratorType      rbegin()       { auto Result = Data.rbegin(); if (Data.Num()) { ++Result; } return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForConstReverseIteratorType rbegin() const { auto Result = Data.rbegin(); if (Data.Num()) { ++Result; } return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForReverseIteratorType      rend  ()       { auto Result = Data.rend();                                 return Result; }
	[[nodiscard]] UE_FORCEINLINE_HINT DataType::RangedForConstReverseIteratorType rend  () const { auto Result = Data.rend();                                 return Result; }
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT const ElementType* operator*() const UE_LIFETIMEBOUND
	{
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT DataType& GetCharArray() UE_LIFETIMEBOUND
	{
		return Data;
	}

	/** Get string as const array of TCHARS */
	[[nodiscard]] UE_FORCEINLINE_HINT const DataType& GetCharArray() const UE_LIFETIMEBOUND
	{
		return Data;
	}
	...
	inline UE_STRING_CLASS& Append(const CharType* Str, int32 Count)
	{
	 ...
	 */
	template<class CharType>
	inline UE_STRING_CLASS& Append(/* no const! */ CharType* Str)
	{
		checkSlow(Str);
	...
	>
	inline UE_STRING_CLASS& Append(CharRangeType&& Str)
	{
	...
	>
	inline UE_STRING_CLASS& operator+=(AppendedCharType Char)
	{
	...
	>
	[[nodiscard]] inline friend UE_STRING_CLASS operator+(const UE_STRING_CLASS& Lhs, CharType Rhs)
	{
		Lhs.CheckInvariants();
	...
	template <
		...
		UE_REQUIRES(TIsCharType_V<CharType>)
	>
	[[nodiscard]] inline friend UE_STRING_CLASS operator+(UE_STRING_CLASS&& Lhs, CharType Rhs)
	{
		Lhs.CheckInvariants();
...
public:
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const UE_STRING_CLASS& Lhs, const UE_STRING_CLASS& Rhs)	{ return ConcatFF(Lhs, Rhs); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(UE_STRING_CLASS&& Lhs, const UE_STRING_CLASS& Rhs)		{ return ConcatFF(MoveTemp(Lhs), Rhs); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const UE_STRING_CLASS& Lhs, UE_STRING_CLASS&& Rhs)		{ return ConcatFF(Lhs,MoveTemp(Rhs)); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(UE_STRING_CLASS&& Lhs, UE_STRING_CLASS&& Rhs)				{ return ConcatFF(MoveTemp(Lhs), MoveTemp(Rhs)); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const ElementType* Lhs, const UE_STRING_CLASS& Rhs)		{ return ConcatCF(Lhs, Rhs); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const ElementType* Lhs, UE_STRING_CLASS&& Rhs)			{ return ConcatCF(Lhs, MoveTemp(Rhs)); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const UE_STRING_CLASS& Lhs, const ElementType* Rhs)		{ return ConcatFC(Lhs, Rhs); }
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(UE_STRING_CLASS&& Lhs, const ElementType* Rhs)			{ return ConcatFC(MoveTemp(Lhs), Rhs); }
	...
	>
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(CharRangeType&& Lhs, const UE_STRING_CLASS& Rhs)
	{
	...
	>
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(CharRangeType&& Lhs, UE_STRING_CLASS&& Rhs)
	{
	...
	>
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(const UE_STRING_CLASS& Lhs, CharRangeType&& Rhs)
	{
	...
	>
	[[nodiscard]] UE_FORCEINLINE_HINT friend UE_STRING_CLASS operator+(UE_STRING_CLASS&& Lhs, CharRangeType&& Rhs)
	{
	 ...
	 */
	inline UE_STRING_CLASS& operator/=(const ElementType* Str)
	{
		checkSlow(Str);
	...
	*/
	...
	>
	inline UE_STRING_CLASS& operator/=(CharRangeType&& Str)
	{
	...
	*/
	template <
		...
		UE_REQUIRES(TIsCharType_V<CharType>)
	>
	inline UE_STRING_CLASS& operator/=(const CharType* Str)
	{
	 ...
	 */
	[[nodiscard]] inline friend UE_STRING_CLASS operator/(const UE_STRING_CLASS& Lhs, const ElementType* Rhs)
	{
		checkSlow(Rhs);
	 ...
	 * @return The new concatenated path
	 */
	[[nodiscard]] inline friend UE_STRING_CLASS operator/(UE_STRING_CLASS&& Lhs, const ElementType* Rhs)
	{
		checkSlow(Rhs);
	 ...
	 * @return The new concatenated path
	 */
	[[nodiscard]] inline friend UE_STRING_CLASS operator/(const UE_STRING_CLASS& Lhs, const UE_STRING_CLASS& Rhs)
	{
	 ...
	 * @return The new concatenated path
	 */
	[[nodiscard]] inline friend UE_STRING_CLASS operator/(UE_STRING_CLASS&& Lhs, const UE_STRING_CLASS& Rhs)
	{
		int32 StrLength = Rhs.Len();
	 ...
	 */
	[[nodiscard]] inline friend UE_STRING_CLASS operator/(const ElementType* Lhs, const UE_STRING_CLASS& Rhs)
	{
		int32 StrLength = Rhs.Len();
	 ...
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT bool UEOpLessThan(const UE_STRING_CLASS& Rhs) const
	{
	...
	[[nodiscard]] UE_FORCEINLINE_HINT bool UEOpLessThan(const CharType* Rhs) const
	{
		return FPlatformString::Stricmp(**this, Rhs) < 0;
	}
	 ...
	 */
	template <typename CharType>
	[[nodiscard]] UE_FORCEINLINE_HINT bool UEOpGreaterThan(const CharType* Rhs) const
	{
		return FPlatformString::Stricmp(**this, Rhs) > 0;
	}
	 ...
	 * @note case insensitive
	 */
	[[nodiscard]] UE_FORCEINLINE_HINT bool UEOpEquals(const UE_STRING_CLASS& Rhs) const
	{
	 ...
	 */
	template <typename CharType>
	[[nodiscard]] UE_FORCEINLINE_HINT bool UEOpEquals(const CharType* Rhs) const
	{
		return FPlatformString::Stricmp(**this, Rhs) == 0;
	}

	/** Get the length of the string, excluding terminating character */
	[[nodiscard]] UE_FORCEINLINE_HINT int32 Len() const
	{
		return Data.Num() ? Data.Num() - 1 : 0;
	}

	/** @returns Number of bytes used for characters, excluding the null-terminator and slack */
	[[nodiscard]] UE_FORCEINLINE_HINT SIZE_T NumBytesWithoutNull() const
	{
	...
	[[nodiscard]] UE_FORCEINLINE_HINT SIZE_T NumBytesWithNull() const
	{
		return (static_cast<SIZE_T>(Len()) + 1) * sizeof(ElementType);
	}

	/** Returns the left most given number of characters */
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS Left(int32 Count) const &
	{
		return UE_STRING_CLASS::ConstructFromPtrSize(**this, FMath::Clamp(Count, 0, Len()));
	}

	[[nodiscard]] inline UE_STRING_CLASS Left(int32 Count) &&
	{
	...
	inline void LeftInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
	...
	[[nodiscard]] inline UE_STRING_CLASS LeftChop(int32 Count) const &
	{
		const int32 Length = Len();
		return UE_STRING_CLASS::ConstructFromPtrSize(**this, FMath::Clamp(Length - Count, 0, Length));
	}

	[[nodiscard]] inline UE_STRING_CLASS LeftChop(int32 Count) &&
	{
	...
	inline void LeftChopInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
		const int32 Length = Len();
	...
	[[nodiscard]] inline UE_STRING_CLASS Right(int32 Count) const &
	{
		const int32 Length = Len();
		return UE_STRING_CLASS(**this + Length - FMath::Clamp(Count, 0, Length));
	}

	[[nodiscard]] inline UE_STRING_CLASS Right(int32 Count) &&
	{
	...
	inline void RightInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
		const int32 Length = Len();
	...
	[[nodiscard]] inline UE_STRING_CLASS RightChop(int32 Count) &&
	{
	...
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS Mid(int32 Start) const & { return RightChop(Start); }
	[[nodiscard]] UE_FORCEINLINE_HINT UE_STRING_CLASS Mid(int32 Start) && { return ((UE_STRING_CLASS&&)*this).RightChop(Start); }

	/** Modifies the string such that it is now the substring from Start position for Count characters. */
	inline void MidInline(int32 Start, int32 Count = MAX_int32, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
	...
	>
	[[nodiscard]] inline bool Contains(CharRangeType&& SubStr, ESearchCase::Type SearchCase = ESearchCase::IgnoreCase,
	 ...
	 * @return					Returns whether the string contains the substring. If the substring is empty, returns true.
	 **/
	[[nodiscard]] UE_FORCEINLINE_HINT bool Contains(const ElementType* SubStr, ESearchCase::Type SearchCase = ESearchCase::IgnoreCase,
		ESearchDir::Type SearchDir = ESearchDir::FromStart) const
	{
	 ...
	 * @return					Returns whether the string contains the substring. If the substring is empty, returns true.
	 **/
	[[nodiscard]] UE_FORCEINLINE_HINT bool Contains(const UE_STRING_CLASS& SubStr, ESearchCase::Type SearchCase = ESearchCase::IgnoreCase,
							  ESearchDir::Type SearchDir = ESearchDir::FromStart) const
	{
		return Find(*SubStr, SearchCase, SearchDir) != INDEX_NONE;
	}
	 ...
	 * @return					Returns whether the string contains the substring. If the substring is empty, returns true.
	 **/
	[[nodiscard]] UE_FORCEINLINE_HINT bool Contains(const ElementType* SubStr, int32 SubStrLen,
	...
	inline int32 FindLastCharByPredicate(Predicate Pred, int32 Count) const
	{
	 ...
	 */
	[[nodiscard]] inline bool Equals(const UE_STRING_CLASS& Other, ESearchCase::Type SearchCase = ESearchCase::CaseSensitive) const
	{
		int32 Num = Data.Num();
	 ...
	 */
	[[nodiscard]] inline int32 Compare(const UE_STRING_CLASS& Other, ESearchCase::Type SearchCase = ESearchCase::CaseSensitive) const
	{
		if (SearchCase == ESearchCase::CaseSensitive)
		{
...
public:
	...
	[[nodiscard]] static inline UE_STRING_CLASS FromInt(int32 Num)
	{
		UE_STRING_CLASS Ret;
		Ret.AppendInt(Num); 
		return Ret;
	...
	[[nodiscard]] friend UE_FORCEINLINE_HINT uint32 GetTypeHash(const UE_STRING_CLASS& S)
	{
...
{
	[[nodiscard]] UE_FORCEINLINE_HINT static TCHAR const* GetName()
	{
...
bool LexTryParseString(T& OutValue, const UE_STRING_CHARTYPE* Buffer)
{
	...
	{
		bool bSawZero = false;
		UE_STRING_CHARTYPE C = *Buffer;
		while (C != CHARTEXT(UE_STRING_CHARTYPE, '\0') && (C == CHARTEXT(UE_STRING_CHARTYPE, '+') || C == CHARTEXT(UE_STRING_CHARTYPE, '-') || TChar<UE_STRING_CHARTYPE>::IsWhitespace(C)))
		{
			C = *(++Buffer);
		}

		while (C != CHARTEXT(UE_STRING_CHARTYPE, '\0') && !TChar<UE_STRING_CHARTYPE>::IsWhitespace(C) && (std::is_floating_point_v<T> || C != CHARTEXT(UE_STRING_CHARTYPE, '.')))
		{
			bSawZero = bSawZero || (C == CHARTEXT(UE_STRING_CHARTYPE, '0'));
			if (!bSawZero && C != CHARTEXT(UE_STRING_CHARTYPE, '.'))
			{
				return false;
			}
...
inline bool LexTryParseString(bool& OutValue, const UE_STRING_CHARTYPE* Buffer)
{
	LexFromString(OutValue, Buffer);
	return true;
}
template <typename StringType = FString>
[[nodiscard]] UE_FORCEINLINE_HINT StringType LexToString(UE_STRING_CLASS&& Str)
{
	return MoveTemp(Str);
}

template <typename StringType = FString>
[[nodiscard]] UE_FORCEINLINE_HINT StringType LexToString(const UE_STRING_CLASS& Str)
{
	return Str;
}
 ...
 * }
 */
[[nodiscard]] UE_FORCEINLINE_HINT const UE_STRING_CLASS::ElementType* ToCStr(const UE_STRING_CLASS& Str)
{
	return *Str;
}
