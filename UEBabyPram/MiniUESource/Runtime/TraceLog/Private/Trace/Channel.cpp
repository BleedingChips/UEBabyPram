...
{
	ToggleAllInternal(bEnabled, true);
}

///////////////////////////////////////////////////////////////////////////////
void FChannel::ToggleAllInternal(bool bEnabled, bool bIssueCallback)
{
	using namespace Private;
	...
	for (FChannel* Channel : ChannelLists)
	{
		...
		{
			Channel->ToggleInternal(bEnabled, bIssueCallback);
		}
	}
}
...
///////////////////////////////////////////////////////////////////////////////
bool FChannel::Toggle(bool bEnabled, const TCHAR** OutReason)
{
	return ToggleInternal(bEnabled, true, OutReason);
}

///////////////////////////////////////////////////////////////////////////////
bool FChannel::ToggleInternal(bool bEnabled, bool bIssueCallback, const TCHAR** OutReason)
{
	using namespace Private;

	Private::FLock ScopedLock(&Lock);
	if (ScopedLock.TimedOut())
	{
		static const TCHAR* TimedOutError = TEXT("Timed out waiting for lock");
		if (OutReason)
		{
			*OutReason = TimedOutError;
		}
		return IsEnabled();
	}

	bool bCanToggle = bIssueCallback ? OnToggle(bEnabled, OutReason) : true;
	if (bCanToggle)
	{
...
bool FChannel::Toggle(const ANSICHAR* ChannelName, bool bEnabled)
{
	...
	{
		return Channel->ToggleInternal(bEnabled, true);
	}
	return false;
}
