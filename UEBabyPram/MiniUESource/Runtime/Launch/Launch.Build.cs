...
public class Launch : ModuleRules
{
	...
	bool bEnableIOSCrashDump = false;

	protected virtual bool EnableIOSCrashDump
	{
		get
		{
			ConfigCache.ReadSettings(DirectoryReference.FromFile(Target.ProjectFile), Target.Platform, this);
			return bEnableIOSCrashDump;
		}
	}
	...
	public Launch(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDefinitions.Add("UE_ENABLE_IOS_CRASHDUMP=" + (EnableIOSCrashDump ? "1" : "0"));
