...
IMAGECORE_API int ERawImageFormat::NumChannels(Type Format)
{
	...
	case ERawImageFormat::BGRE8: return 3; // <-
	case ERawImageFormat::RGBA16: return 4;
	case ERawImageFormat::RGBA16F: return 4;
	case ERawImageFormat::RGBA32F: return 4;
	case ERawImageFormat::G16: return 1;
	case ERawImageFormat::R16F: return 1;
	case ERawImageFormat::R32F: return 1;
	default:
		check(0);
		return 0;
	}
...
{
	// "BGRE8" is 8-bit but not *U8*
	return Format == G8 || Format == BGRA8;
}
