...
public:
	...
	/**
	 * Getter for the unix timestamp at the start of all analysis.
	 * This function should be used as an offset for any relative (session) timestamps to calculate
	 * real UTC timestamps.
	 */
	virtual double GetBaseDateTime() const = 0;
	virtual void SetBaseDateTime(double InBaseDateTime) = 0;
