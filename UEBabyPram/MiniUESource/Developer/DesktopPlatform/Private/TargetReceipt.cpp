...
bool FTargetReceipt::Read(const FString& FileName, bool bExpandVariables)
{
	...
	if (!Object->TryGetStringField(TEXT("BuildSettingsVersion"), BuildSettingsVersion))
	{
		// This was added at 5.7; no-op on failure.
	}
	if (!Object->TryGetStringField(TEXT("TargetBuildEnvironment"), TargetBuildEnvironment))
	{
		// This was added at 5.7; no-op on failure.
	}
