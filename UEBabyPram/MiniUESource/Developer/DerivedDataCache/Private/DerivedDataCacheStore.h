...
struct TCacheRequestTraits;

template <>
struct TCacheRequestTraits<FCachePutRequest>
{
	...
	constexpr static void (ICacheStore::*Function)(TConstArrayView<FRequest>, IRequestOwner&, FOnComplete&&) = &ICacheStore::Put;
};

template <>
struct TCacheRequestTraits<FCacheGetRequest>
{
	...
	constexpr static void (ICacheStore::*Function)(TConstArrayView<FRequest>, IRequestOwner&, FOnComplete&&) = &ICacheStore::Get;
};

template <>
struct TCacheRequestTraits<FCachePutValueRequest>
{
	...
	constexpr static void (ICacheStore::*Function)(TConstArrayView<FRequest>, IRequestOwner&, FOnComplete&&) = &ICacheStore::PutValue;
};

template <>
struct TCacheRequestTraits<FCacheGetValueRequest>
{
	...
	constexpr static void (ICacheStore::*Function)(TConstArrayView<FRequest>, IRequestOwner&, FOnComplete&&) = &ICacheStore::GetValue;
};

template <>
struct TCacheRequestTraits<FCacheGetChunkRequest>
{
	...
	constexpr static void (ICacheStore::*Function)(TConstArrayView<FRequest>, IRequestOwner&, FOnComplete&&) = &ICacheStore::GetChunks;
};

} // Private

/** Alias for the response type corresponding to the request type. */
template <typename RequestType> using TCacheResponseFor = typename Private::TCacheRequestTraits<RequestType>::FResponse;

/** Alias for the completion callback type corresponding to the request type. */
template <typename RequestType> using TCacheOnCompleteFor = typename Private::TCacheRequestTraits<RequestType>::FOnComplete;

/** Alias for the cache method corresponding to the request type. */
template <typename RequestType> inline constexpr auto CacheMethodFor = Private::TCacheRequestTraits<RequestType>::Method;

/** Alias for the cache function corresponding to the request type. */
template <typename RequestType> inline constexpr auto CacheFunctionFor = Private::TCacheRequestTraits<RequestType>::Function;
