...
namespace UEBabyPram::InsightParser
{
	...
	////////////////////////////////////////////////////////////////////////////////
	double IAnalyzer::FEventTime::GetBaseDateTimestamp() const
	{
		const auto* Timing = (const FTiming*)this;
		return Timing->BaseDateTimestamp;
	}
	...
	const void* IAnalyzer::FArrayReader::GetImpl(uint32 Index, int8& SizeAndType) const
	{
		...
		SizeAndType = (SizeAndType < 0) ? static_cast<int8>(-SizeAndType) : SizeAndType;
	...
	const FTypeRegistry::FTypeInfo* FTypeRegistry::AddVersion4(const void* TraceData)
	{
		...
		for (int32 i = 0, n = NewEvent.FieldCount; i < n; ++i)
		{
			...
			{
				TypeSize = static_cast<int8>(-TypeSize);
			}
	...
	void FTraceAnalyzer::OnTiming(const FOnEventContext& Context)
	{
		...
		double StartDateTime = Context.EventData.GetValue<double>("StartDateTime");
		...
		State.Timing.BaseDateTimestamp = StartDateTime;
	}
